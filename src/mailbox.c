 ...
 * JNOS 2.0
 *
 * $Id: mailbox.c,v 1.8 2013/09/15 14:55:03 ve4klm Exp ve4klm $
 *
    ...
    switch(sp.sa->sa_family){
        ...
        case AF_INET:
			 ...
			 */
				...
				{
					struct usock *up;
					log (m->user, "possible airmail telnet client ...");
...
/* Incoming mailbox session for a port flagged as cronly (see tipmail.c) */
void
mbx_incom_cr(s,t,p)
int s;
void *t;
