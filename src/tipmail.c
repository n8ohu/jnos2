...
void *p;
{
    ...
    if (argc > 2 && !stricmp(argv[2],"cronly"))
        return start_tcp(port,"MBOX Server",mbx_incom_cr,2048);
    else
#endif /* MB_XFBB_KLUDGE */
    return start_tcp(port,"MBOX Server",mbx_incom,8192);
#else
